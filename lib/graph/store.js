...
export const CONTRACT_KINDS = ['event', 'api', 'table', 'schema', 'rpc', 'topic', 'other'];
...
export class RepoGraphStore {
    ...
    addManualEdge(input) {
        ...
        if (input.contractRef !== undefined && !CONTRACT_KINDS.includes(input.contractRef.kind)) {
            throw new TypeError('RepoGraphStore.addManualEdge: unknown contractRef.kind ' + JSON.stringify(input.contractRef.kind));
        }
