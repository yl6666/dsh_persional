...
export type RepoRunState = 'pending' | 'running' | 'succeeded' | 'failed' | 'rolled-back' | 'needs-human' | 'submit-pending' | 'submitted';
...
export type RequirementStatus = 'draft' | 'clarifying' | 'spec-ready' | 'analyzed' | 'planned' | 'dispatched';
